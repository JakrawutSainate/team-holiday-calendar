          ...
          {isLoading ? (
            <div className="p-16 flex flex-col justify-center items-center gap-3 text-zinc-400">
              ...
              <span className="text-xs font-semibold">
                {language === 'th' ? 'กำลังโหลดรายละเอียดแผนก...' : 'Loading division summaries...'}
              </span>
            </div>
          ) : (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <span className="px-2.5 py-1 bg-zinc-50 border border-zinc-200 rounded-xl text-xs font-bold text-zinc-800">
